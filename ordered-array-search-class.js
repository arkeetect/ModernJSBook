        ...
        if (this.ordArray[end] == searchVal) {
            ...
            if (this.ordArray[start + Math.floor((end - start) / 2)] > searchVal) {
                ...
                if (this.ordArray[start] === searchVal) {
                    ...
                    console.log(this.ordArray[start]);
                    this.result = start;
                    return start; //this.ordArray[start];
                }
...
const unboundSearch = myArr.search;
//const boundSearch = myArr.search.bind(myArr);
